...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 9 * 60; // Selenium: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // Selenium: 1 minutes
        ...
        // selenium consensus based parameters
        ...
        consensus.nMinimumStakeValue = 5 * COIN;
        consensus.nStakeMinAge = 700 * 60;
        consensus.nStakeMaxAge = 60 * 60 * 24 * 30;
        consensus.nModifierInterval = 60;

        // selenium height based parameters
        consensus.nLastPoWBlock = 1000;
        consensus.nHardenedStakeCheckHeight = 1000;
        ...
        genesis = CreateGenesisBlock(1731558249, 571297, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000080349ae4ba8d7e2edc2e70672ceb729a4cae2caaca6b379effcd51a8378"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = {0x3F};
        // selenium script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = {0x0a};
        // selenium private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] = {0xcc};
        // selenium BIP32 pubkeys start with 'pacp'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x03, 0xdd, 0x3e, 0x31};
        // selenium BIP32 prvkeys start with 'pacv'
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0xdd, 0x3e, 0x5a};

        // selenium BIP44 coin type is '8192'
        nExtCoinType = 8192;
        ...
        consensus.llmqTypeInstantSend = Consensus::LLMQ_400_60;
        consensus.llmqTypePlatform = Consensus::LLMQ_400_60;
        ...
        vSporkAddresses = {"SgcAsupZeJxs1bxKsBYj9QzKkucBcrzTPn"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        // selenium addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = {0x8c};
        // selenium script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = {0x13};
        // selenium private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = {0xef};
        // selenium BIP32 pubkeys start with 'tacp'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x30, 0x68, 0x80};
        // selenium BIP32 prvkeys start with 'tacv'
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // selenium: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // selenium: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        ...
        // Testnet SELENIUM addresses start with 'y'
...
public:
    CRegTestParams() {
        ...
        // Regtest SELENIUM addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
