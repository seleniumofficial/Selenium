...
// note - rebased iamunick's 'nextpaymentblock' rpc call from https://github.com/SELENIUMOfficial/SELENIUM/pull/21
...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner SELENIUM address\n"
            "  payee          - Print the masternode payout SELENIUM address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting SELENIUM address\n"
        );
}
