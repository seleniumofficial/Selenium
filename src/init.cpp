 ...
 * between seleniumd, and dash-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/selenium/selenium>";
    const std::string URL_WEBSITE = "<https://selenium.com>";
...
/** Sanity checks
 *  Ensure that selenium is running in a usable environment with all
...
{
    // Make sure only a single selenium process is using the data directory.
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 10d: setup SELENIUM-specific tasks
