...
//! Interface for the src/evo part of a dash node (seleniumd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a dash node (seleniumd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a dash node (seleniumd process).
...
//! Top-level interface for a dash node (seleniumd process).
class Node
{
public:
    virtual ~Node() {}
